...
resource "proxmox_virtual_environment_download_file" "debian_12_disk" {
  url          = "https://cdimage.debian.org/images/cloud/bookworm/20250316-2053/debian-12-generic-amd64-20250316-2053.qcow2"
  verify       = false
  datastore_id = var.image_datastore_id
  node_name    = var.proxmox_node_name
  content_type = "iso"
  file_name    = "debian-12-generic-amd64-20250316-2053.img"
}
